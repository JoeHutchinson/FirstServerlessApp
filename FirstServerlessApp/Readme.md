...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *FirstServerlessApp*):

Restore dependencies
```
    cd "FirstServerlessApp"
    dotnet restore
```

Execute unit tests
```
    cd "FirstServerlessApp/test/FirstServerlessApp.Tests"
    dotnet test
```

Deploy application
```
    cd "FirstServerlessApp/src/FirstServerlessApp"
